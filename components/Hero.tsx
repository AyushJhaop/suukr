        ...
        <section className="relative w-full h-screen flex flex-col items-center justify-center overflow-hidden">
            ...
            <div className="relative z-20 flex flex-col items-center text-center px-4 max-w-4xl mx-auto">
                <motion.h1
                    ...
                    className="font-heading text-5xl md:text-7xl lg:text-8xl text-deepRed font-semibold mb-6 tracking-tight"
                >
                ...
                <motion.p
                    ...
                    className="font-body text-lg md:text-2xl text-black/80 font-medium mb-10 tracking-wide"
                >
                ...
                >
                    <motion.button
                        whileTap={{ scale: 0.95 }}
                        className="px-8 py-4 bg-deepRed text-whiteOff font-body font-semibold rounded-full shadow-lg transition-colors"
                    >
                        Order Now
                    </motion.button>
                    ...
                    <motion.button
                        whileTap={{ scale: 0.95 }}
                        className="px-8 py-4 bg-[#FFDEDE] border-none text-black font-body font-semibold rounded-full backdrop-blur-sm transition-colors"
                    >
                        View Menu
                    </motion.button>
                </motion.div>
            ...
            <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none z-30 transform translate-y-[2px]">
                <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" className="block w-full h-[100px] md:h-[150px] lg:h-[200px]">
