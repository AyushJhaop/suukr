...
export default function Footer() {
    ...
    return (
        <footer className="relative w-full bg-[#721011] overflow-hidden z-20 pt-20 pb-10 mt-20">
            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto px-8 flex flex-col lg:flex-row items-start justify-between gap-16">

                {/* Left Side: Newsletter Form */}
                <div className="w-full lg:w-1/2">
                    <div className="mb-8">
                        <h2 className="font-heading font-bold text-3xl md:text-4xl text-[#D5AF34] mb-4 leading-tight">
                            Your Inbox, More Sprinkles !
                        </h2>
                        <p className="text-[#FEF2F2] text-lg font-medium leading-relaxed">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4 mb-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full px-6 py-4 bg-[#5a0d0d] border-2 border-[#FEF2F2]/20 rounded-full text-[#FEF2F2] placeholder:text-[#FEF2F2]/60 font-medium text-base focus:outline-none focus:border-[#D5AF34] transition-colors"
                                    required
                                />
                            </div>
                            <div className="relative">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="relative">
                                <select
                                    ...
                                    onChange={handleInputChange}
                                    className="w-full px-6 py-4 bg-[#5a0d0d] border-2 border-[#FEF2F2]/20 rounded-full text-[#FEF2F2] font-medium text-base focus:outline-none focus:border-[#D5AF34] transition-colors appearance-none cursor-pointer"
                                >
                        ...
                        {/* Terms & Submit Row */}
                        <div className="bg-[#4A1A1A] rounded-full p-2 flex items-center justify-between">
                            <div className="flex items-center px-4 py-2 flex-1">
                                <input
                                    ...
                                    onChange={handleInputChange}
                                    className="w-5 h-5 rounded border-2 border-[#FEF2F2]/40 bg-transparent checked:bg-[#D5AF34] checked:border-[#D5AF34] mr-4 cursor-pointer"
                                    required
                                />
                                <label htmlFor="terms" className="text-[#FEF2F2] font-medium text-sm cursor-pointer flex-1">
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                className="bg-[#D5AF34] text-[#721011] font-heading font-bold text-lg px-6 py-3 rounded-full flex items-center gap-2 transition-colors hover:bg-[#c49e24]"
                            >
                                Submit
                    ...
                    {/* Legal Text */}
                    <div className="text-[#FEF2F2]/80 text-sm font-medium leading-relaxed">
                        <p>
                ...
                <div className="w-full lg:w-1/2 flex flex-col sm:flex-row lg:flex-col items-start justify-between gap-16">
            ...
            {/* Divider */}
            <div className="relative z-10 w-[90%] max-w-7xl mx-auto h-px bg-[#FEF2F2]/20 mt-16 mb-8" />

            {/* Copyright */}
            <p className="relative z-10 font-body text-[#FEF2F2]/60 text-sm tracking-wide text-center">
